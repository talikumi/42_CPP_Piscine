...
void Harl::info ( void )
{
	...
	std::cout << " put enough bacon in my burger! If you did, I wouldn’t be asking for more!" << std::endl << std::endl;
}
...
void Harl::warning ( void )
{
	...
	std::cout << " ccoming for years whereas you started working here since last month." << std::endl << std::endl;
}
